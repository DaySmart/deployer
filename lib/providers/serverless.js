    ...
    async executeServerless(command) {
        ...
        if (serverlessVersion[0] === "2") {
            ...
            try {
                ...
                ({ c, cs, opt, isHelpRequest, commandSchema } = resolveInput(require(path.resolve(serverlessPath, '../cli/commands-schema/aws-service'))));
                let fulfilledSources = [];
                ...
                Object.assign(resolverConfiguration.sources, {
                    cf: require(path.resolve(serverlessPath, '../configuration/variables/sources/instance-dependent/get-cf'))(sls),
                    s3: require(path.resolve(serverlessPath, '../configuration/variables/sources/instance-dependent/get-s3'))(sls),
                    ssm: require(path.resolve(serverlessPath, '../configuration/variables/sources/instance-dependent/get-ssm'))(sls),
                    aws: require(path.resolve(serverlessPath, '../configuration/variables/sources/instance-dependent/get-aws'))(sls),
                });
                await resolveVariables(resolverConfiguration);
